angular.module('app').controller('tronBuytokensController', function($scope, $timeout, $rootScope, $filter, $state,
    ...
    $scope.checkTronishAmount = function() {
        ...
        $scope.formData.tronishAmount  = tronishAmount.div(rate).toFixed(2).toString(10);
    ...
    $scope.checkWishesAmount = function() {
        ...
        $scope.formData.tronishAmount  = wishesAmount.div(rate).toFixed(2).toString(10);
    ...
    $scope.checkEthAmount = function() {
        ...
        $scope.formData.ethAmount = ethAmount.times(rate).toFixed(2).toString(10);
        $scope.formData.amount = $scope.formData.ethAmount;
    };
    ...
    $scope.checkBtcAmount = function() {
        ...
        $scope.formData.btcAmount = btcAmount.times(rate).toFixed(2).toString(10);
    };
