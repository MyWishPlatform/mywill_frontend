angular.module('app').controller('xinfinTokenPreviewController', function($timeout, $rootScope, contractService, $location,
    ...
    $scope.is0x = function(item) {
        if (item.slice(0,2) === '0x'){
            return 'xdc' + item.slice(2);
        }
        return item;
    }
