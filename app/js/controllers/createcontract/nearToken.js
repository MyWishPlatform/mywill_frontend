angular.module('app').controller('nearTokenCreateController', function($scope, contractService, $timeout, $state, $rootScope, NETWORKS_TYPES_CONSTANTS,
    ...
    contract.contract_details.token_type = 'NEP-141';
    ...
    var generateContractData = function() {
        ...
        return {
            ...
            contract_type: CONTRACT_TYPES_CONSTANTS.NEAR_TOKEN,
    ...
    var checkDraftContract = function(redirect) {
        if (localStorage.draftContract) {
            if (!contract.id) {
                ...
                if (draftContract.contract_type == CONTRACT_TYPES_CONSTANTS.NEAR_TOKEN) {
