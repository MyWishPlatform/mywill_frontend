angular.module('app').controller('tronLostKeyCreateController', function($scope, contractService, $timeout, $state, $rootScope,
    ...
    var checkDraftContract = function(redirect) {
        if (localStorage.draftContract && !contract.id) {
            if (!contract.id) {
                ...
                if (draftContract.contract_type == CONTRACT_TYPES_CONSTANTS.TRON_LOST_KEY) {
