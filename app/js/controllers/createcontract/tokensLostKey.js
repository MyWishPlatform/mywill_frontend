angular.module('app').controller('tokensLostKeyCreateController', function($scope, contractService, $timeout, $state, $rootScope,
    ...
    var generateContractData = function() {
        ...
        return {
            ...
            id: contract.id,
            contract_type: CONTRACT_TYPES_CONSTANTS.TOKENS_LOST_KEY,
    ...
    var checkDraftContract = function(redirect) {
        if (localStorage.draftContract && !contract.id) {
            if (!contract.id) {
                ...
                if (draftContract.contract_type == CONTRACT_TYPES_CONSTANTS.TOKENS_LOST_KEY) {
