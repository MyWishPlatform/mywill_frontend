angular.module('app').controller('bnbCrowdSaleCreateController', function($scope, currencyRate, contractService, $location, tokensList, APP_CONSTANTS, $stateParams, web3Service,
    ...
    var generateContractData = function() {
        ...
        return {
            ...
            contract_type: CONTRACT_TYPES_CONSTANTS.BNB_CROWD_SALE,
    ...
    var checkDraftContract = function(redirect) {
        if (localStorage.draftContract && !contract.id) {
            if (!contract.id) {
                ...
                if (draftContract.contract_type == CONTRACT_TYPES_CONSTANTS.BNB_CROWD_SALE) {
...
}).controller('bnbCrowdSaleTimeBonusesController', function($scope, $timeout) {
    ...
    resetFormData();
}).controller('bnbCrowdSaleAmountBonusesController', function($scope) {
    ...
    $scope.$on('createContract', createdContractData);
    $scope.createAmountBonusChartData();
}).controller('bnbCrowdSaleHoldersController', function($scope, $timeout, $filter) {
