angular.module('app').controller('bnbLostKeyCreateController', function($scope, contractService, $timeout, $state, $rootScope,
    ...
    var generateContractData = function() {
        return {
            ...
            id: contract.id,
            contract_type: CONTRACT_TYPES_CONSTANTS.BNB_LOST_KEY,
    ...
    var checkDraftContract = function(redirect) {
        if (localStorage.draftContract && !contract.id) {
            if (!contract.id) {
                ...
                if (draftContract.contract_type == CONTRACT_TYPES_CONSTANTS.BNB_LOST_KEY) {
