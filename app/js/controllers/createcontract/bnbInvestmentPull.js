angular.module('app').controller('bnbInvestmentPullCreateController', function($scope, contractService, $timeout, $state, $rootScope,
    ...
    var contract = openedContract && openedContract.data ? openedContract.data : {
        ...
        contract_type: CONTRACT_TYPES_CONSTANTS.BNB_INVESTMENT_PULL,
    ...
    var checkDraftContract = function(redirect) {
        if (localStorage.draftContract && !contract.id) {
            if (!contract.id) {
                ...
                if (draftContract.contract_type == CONTRACT_TYPES_CONSTANTS.BNB_INVESTMENT_PULL) {
