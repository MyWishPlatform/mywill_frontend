angular.module('app').controller('eosITokenCreateController', function($scope, contractService, $timeout, $state, $rootScope, NETWORKS_TYPES_CONSTANTS,
    ...
    var generateContractData = function() {
        ...
        return {
            ...
            contract_type: CONTRACT_TYPES_CONSTANTS.EOS_I_TOKEN,
    ...
    var checkDraftContract = function(redirect) {
        if (localStorage.draftContract) {
            if (!contract.id) {
                ...
                if (draftContract.contract_type == CONTRACT_TYPES_CONSTANTS.EOS_I_TOKEN) {
