angular.module('app').controller('tronTokenCreateController', function($scope, contractService, $timeout, $state, $rootScope, NETWORKS_TYPES_CONSTANTS,
    ...
    var generateContractData = function() {
        ...
        return {
            ...
            contract_type: CONTRACT_TYPES_CONSTANTS.TRON_TOKEN,
